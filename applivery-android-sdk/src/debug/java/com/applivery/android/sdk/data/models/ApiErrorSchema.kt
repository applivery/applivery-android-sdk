...
internal sealed class ApiError(val message: String?) {
...
internal class ApiErrorContainerSchema(
    @SerializedName("error") val data: ApiErrorSchema?
)

internal data class ApiErrorSchema(
...
internal fun ApiError?.orDefault(): ApiError = this ?: ApiError.Internal()
