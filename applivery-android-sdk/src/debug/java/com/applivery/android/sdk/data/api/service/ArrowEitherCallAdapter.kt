...
internal class ArrowEitherCallAdapter<E, R>(
    ...
    override fun adapt(call: Call<R>): Call<Either<E, R>> = EitherCall(
        call,
        errorConverter,
        bodyType
    )
    ...
    class EitherCall<E, R>(
        ...
        override fun clone(): Call<Either<E, R>> = EitherCall(
            original.clone(),
            errorConverter,
            bodyType
        )
        ...
        override fun execute(): Response<Either<E, R>> = throw UnsupportedOperationException(
            "This adapter does not support sync execution"
        )
