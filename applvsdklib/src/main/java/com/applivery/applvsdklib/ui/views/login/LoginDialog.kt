    ...
    builder.setView(inflater.inflate(R.layout.applivery_dialog_login, null))
        .setPositiveButton(R.string.appliveryLogin, { dialog, _ ->
          ...
          with(dialog as AlertDialog) {
            val usernameEditText = this.findViewById(R.id.appliveryUsernameEditText) as EditText
            val passwordEditText = this.findViewById(R.id.appliveryPasswordEditText) as EditText
