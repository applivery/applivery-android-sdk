...
public class ApiDeviceInfoRequestMapper implements RequestMapper<FeedbackWrapper, ApiDeviceInfoData>{
  ...
  public ApiDeviceInfoRequestMapper(ApiDeviceRequestMapper apiDeviceRequestMapper,
  ...
  @Override public ApiDeviceInfoData modelToData(FeedbackWrapper feedbackWrapper) {

    ApiDeviceData apiDeviceData = apiDeviceRequestMapper.modelToData(feedbackWrapper);
    ApiOsData apiOsData = apiOsRequestMapper.modelToData(feedbackWrapper);

    return new ApiDeviceInfoData(apiDeviceData, apiOsData);
  }
